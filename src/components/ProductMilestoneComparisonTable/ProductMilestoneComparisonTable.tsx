...
import { IDeliveredArtifactInMilestones, IParsedArtifact, IProductMilestoneComparisonData } from 'services/productMilestoneApi';
...
interface IProductMilestoneComparisonTableProps {
  serviceContainerProductMilestoneComparisonTable: IServiceContainer<
    IDeliveredArtifactInMilestones[],
...
const chooseArtifactDeliveredInMilestone = (parsedArtifacts: IParsedArtifact[]): IParsedArtifact | undefined => {
